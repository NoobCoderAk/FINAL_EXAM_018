...
import pws.uas.FINAL_EXAM.exceptions.NonexistentEntityException;
import pws.uas.FINAL_EXAM.exceptions.PreexistingEntityException;
...
public class SuratJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pws.uas_FINAL_EXAM_jar_0.0.1-SNAPSHOTPU");
